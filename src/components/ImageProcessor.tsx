        ...
        <div className="space-y-6">
          <Card className="border-muted/40 shadow-md">
            <CardContent className="p-6 space-y-6">
              <div>
                <h4 className="text-sm font-medium mb-3">选择输出格式</h4>
